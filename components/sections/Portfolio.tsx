          ...
          {filtered.map((project) => (
            ...
            >
              <a
                ...
                className="group glass rounded-2xl overflow-hidden block hover:border-blue-500/20 transition-all duration-300"
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-[11px] text-[#555566] mt-0.5">{project.category}</p>
                </div>
              </a>
            </motion.li>
          ))}
